...
class Stock:
    def __init__(self,root):
        ...
        b1_2=Button(bg_img,text="Entry to Stock",cursor="hand2",command=self.scanner,font=("Times New Roman",13,"bold"),bg="Teal",fg="Black") 
            ...
            for obj in barcode:
                ...
                if result >0:
                    try:
                        ...
                        my_cursor.execute('''INSERT INTO tank_details (QR_Code_ID,Date,Time,Status) VALUES (%s,%s,%s,%s)''',((data),(dString),(tString),("Stock")))  
